...
(function(){
  angular.module('nioExplorer.address', ['ngRoute', 'ui.bootstrap']).controller('addressInfoCtrl', function($rootScope, $scope, $location, $routeParams, $q){
      ...
      return web3.eth.getBalance($scope.addressId, function(err, balance){
        ...
        return web3.eth.getCode($scope.addressId, function(err, code){
          ...
          return web3.eth.getTransactionCount($scope.addressId, function(err, transactions){
            var balanceInEther;
            balanceInEther = web3.fromWei(balance, 'ether').toLocaleString();
